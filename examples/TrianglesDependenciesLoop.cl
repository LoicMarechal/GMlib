...
__kernel void TrianglesScatter(	__global int4 *TriVer, __global float4 (*TriPos)[3], __global float4 *VerCrd, \
...
__kernel void TrianglesGather1(	__global char *VerDeg, __global int8 *VerBal, __global float4 (*TriPos)[3], \
...
__kernel void TrianglesGather2(	__global int (*ExtDeg)[3], __global int *ExtBal, __global float4 (*TriPos)[3], \
								__global float4 *VerCrd, __global GmlParSct *par, const int count )
{
