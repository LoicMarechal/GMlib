...
__kernel void QuadsScatter(	__global int4 *QadVer, __global float4 (*QadPos)[4], __global float4 *VerCrd, \
...
__kernel void QuadsGather1(	__global char *VerDeg, __global int4 *VerBal, __global float4 (*QadPos)[4], \
...
__kernel void QuadsGather2(	__global int (*ExtDeg)[3], __global int *ExtBal, __global float4 (*QadPos)[4], \
							__global float4 *VerCrd, __global GmlParSct *par, const int count )
{
