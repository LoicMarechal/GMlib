...
__kernel void EdgesScatter(__global int2 *EdgVer, __global float4 (*EdgPos)[2], \
...
__kernel void EdgesGather1(__global char *VerDeg, __global int16 *VerBal, \
                           __global float4 (*EdgPos)[2], __global float4 *VerCrd, \
...
__kernel void EdgesGather2(__global int (*ExtDeg)[3], __global int *ExtBal, \
                           __global float4 (*EdgPos)[2], __global float4 *VerCrd, \
                           __global GmlParSct *par, const int count )
{
