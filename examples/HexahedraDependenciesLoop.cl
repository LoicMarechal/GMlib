...
__kernel void HexahedraScatter(  __global int8 *HexVer, __global float4 (*HexPos)[8],\
...
__kernel void HexahedraGather1(  __global char *VerDeg, __global int8 *VerBal, \
                                 __global float4 (*HexPos)[8], __global float4 *VerCrd, \
...
__kernel void HexahedraGather2(  __global int (*ExtDeg)[3], __global int *ExtBal, \
                                 __global float4 (*HexPos)[8], __global float4 *VerCrd, \
                                 __global GmlParSct *par, const int count )
{
